...
class ReporteController extends Controller
{
    public function index()
    {
        ...
        $labels =collect();
        $asignados= collect(); $finalizados = collect();
        foreach ($users as $user) {
            $labels->push($user->nickname);
            $asignado = $user->tickets->where('gestion',Carbon::now()->year)->where('estado','A')->count();
    ...
    public function informes()
    {
    	...
    	$tipos = ['todos'=>'TODOS LOS INF.','baja'=>'INF. TEC. BAJA','reparacion'=>'INF. TEC. REPARACION','reposicion'=>'INF. TEC. REPOSICION','recepcion'=>'INF. TEC. RECEPCION','externos'=>'INF. TEC. EXTERNOS'];
