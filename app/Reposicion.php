...
class Reposicion extends Model
{
    ...
    protected $fillable = [
        'nro_informe','ticket_id', 'user_id', 'asunto', 'gestion', 'equipo_faltante', 'equipo_repuesto', 'observaciones','fecha_informe','observacion_fecha','funcionario_id','userfecha','fecha_solicitud'
    ];
    ...
    protected $morphClass = 'reposicion';
