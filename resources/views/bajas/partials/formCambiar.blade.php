            ...
            <div class="box-body">
                <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                        ...
                        <p class='text-muted'><strong>Nro. de Informe:</strong>{{ $baja->nro_informe }}</p>
                        <p class='text-muted'><strong>Fecha del Informe:</strong>{{ $baja->fecha_informe }}</p>
                        <p class='text-muted'><strong>Solicitante:</strong>{{ $baja->ticket->solicitante }}</p>
                        <p class='text-muted'><strong>Asunto:</strong>{{ $baja->asunto }}</p>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="form-group text-center">
	...
	<a href="{{ route('bajas.index') }}" class="btn btn-flat btn-danger">CANCELAR</a>
</div>
