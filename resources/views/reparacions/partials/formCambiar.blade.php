            ...
            <div class="box-body">
                <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                        ...
                        <p class='text-muted'><strong>Nro. de Informe:</strong>{{ $reparacion->nro_informe }}</p>
                        <p class='text-muted'><strong>Fecha del Informe:</strong>{{ $reparacion->fecha_informe }}</p>
                        <p class='text-muted'><strong>Solicitante:</strong>{{ $reparacion->ticket->solicitante }}</p>
                        <p class='text-muted'><strong>Asunto:</strong>{{ $reparacion->asunto }}</p>
                    </li>
                </ul>
            </div>
        </div>
