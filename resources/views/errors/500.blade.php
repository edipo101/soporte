...
<body>
    <div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>error</h2>
            <p>Ocurrio un fallo inesperado,si el error sigue contactarse con la oficina de desarrollo, para informar sobre el fallo. :) :P<br>
                Vuelva a la pagina principal <a href="{{ url('/') }}" class="link"> VOLVER</a>
            </p>
        </div>
