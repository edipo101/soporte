            ...
            <div class="box-body">
                <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                        ...
                        <p class='text-muted'><strong>Nro. de Informe:</strong>{{ $reposicion->nro_informe }}</p>
                        <p class='text-muted'><strong>Fecha del Informe:</strong>{{ $reposicion->fecha_informe }}</p>
                        <p class='text-muted'><strong>Solicitante:</strong>{{ $reposicion->ticket->solicitante }}</p>
                        <p class='text-muted'><strong>Asunto:</strong>{{ $reposicion->asunto }}</p>
                    </li>
                </ul>
            </div>
        </div>
